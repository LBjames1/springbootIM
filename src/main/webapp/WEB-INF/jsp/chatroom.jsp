...
<html>
  <head>
	...
	<script src="${ctx}/static/js/jquery.qqFace.js"></script>
  			...
  			<div class="col-md-9">
				  ...
				  <div class="panel-body">
				    <div class="well" id="log-container" style="height:400px;overflow-y:scroll">
				    	...
				    	<input type="text" name="myinfo" id="myinfo" class="form-control col-md-12" /> <br>
...
<script>
    $(document).ready(function() {
        ...
        websocket.onmessage = function(event) {
			...
			var text=data.text;
			if(data.text.indexOf('[em_')!=-1){
                text=replace_em(data.text);
			}
            $("#log-container").append("<div class='bg-info'><label class='text-danger'>"+data.fromName+"&nbsp;"+data.date+"</label><div class='text-success'>"+text+"</div></div><br>");
            // 滚动条滚动到最低部
            scrollToBottom();
        ...
        $("#send").click(function(){
        	$.post("getuid",{"username":$("body").data("to")},function(d){
				...
				if(v==""){
					...
					$("#log-container").append("<div class='bg-success'><label class='text-info'>我&nbsp;"+new Date()+"</label><div class='text-info'>"+text+"</div></div><br>");
					scrollToBottom();
					$("#myinfo").val("");
				}
        	});
   ...
   function scrollToBottom(){
    ...
    function replace_em(str){
        ...
        str = str.replace(/\>/g,'&gt;');
        str = str.replace(/\n/g,'<br/>');
        str = str.replace(/\[em_([0-9]*)\]/g,'<img src="${ctx}/static/arclist/$1.gif" border="0" />');
        return str;
    }
